...
from dbmanage.myapp.models import Db_name,Db_account,Db_instance,Oper_log,Task
from dbmanage.myapp.form import LoginForm
from django.db.models import Count
from dbmanage.myapp.include import function as func,meta
